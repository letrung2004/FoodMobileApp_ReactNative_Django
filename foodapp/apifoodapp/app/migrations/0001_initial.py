# Generated by Django 5.1.2 on 2024-12-16 07:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(null=True, upload_to='upload/%Y/%m')),
                ('active', models.BooleanField(default=True)),
                ('restaurant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='main_categories', to='app.restaurant')),
            ],
        ),
        migrations.CreateModel(
            name='Food',
